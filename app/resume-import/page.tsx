...
const SectionWithHeadingAndCreateButton = ({
  ...
  return (
    <>
      <p className="font-semibold text-gray-500">{heading}</p>
      <div className="mt-5">
        <Link
          href="/resume-builder"
          className="outline-theme-blue rounded-full bg-orange-500 px-6 pb-2 pt-1.5 text-base font-semibold text-white"
        >
          {buttonText}
        </Link>
      </div>
