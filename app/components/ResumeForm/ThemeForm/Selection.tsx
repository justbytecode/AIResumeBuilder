...
const SelectionComponent = ({
  ...
  return (
    <div
      className="flex w-[105px] text-white bg-gray-900 cursor-pointer items-center justify-center rounded-md border border-gray-300 py-1.5 shadow-sm hover:border-gray-800 hover:bg-gray-800"
      onClick={onClick}
